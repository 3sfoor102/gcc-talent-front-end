            ...
            <div className="bg-brand-teal text-white py-24 px-6 text-center relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        ...
                        <Link to="/sign-in" className="px-8 py-3.5 bg-transparent border-2 border-cream-200 text-cream-200 font-bold rounded-lg no-underline hover:bg-cream-200 hover:text-brand-teal transition-colors text-lg">
                            Log In
                        </Link>
                    </div>
                </div>
