...
const FreelancerSearchPage = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-cream-100">
                    ...
                    <div className="flex gap-2">
                        <button
                            ...
                            className="px-3 py-1.5 text-xs text-gray-600 hover:bg-gray-100 rounded border border-gray-300 cursor-pointer"
                        >
                            Clear
                        </button>
                        <button
                            type="submit"
                            className="px-5 py-1.5 text-xs font-semibold bg-brand-teal text-white rounded hover:bg-teal-900 cursor-pointer"
                        >
                            Apply Filters
                        </button>
                    </div>
            ...
            {loading ? (
                <div className="text-center py-12 text-brand-teal font-medium">Searching profiles...</div>
                            ...
                            >
                                ...
                                <div>
                                    <div className="flex items-start gap-3 mb-3 pr-6">
                                        ...
                                        <div>
                                            <h3 className="font-bold text-ink text-sm leading-tight">{u.name || 'Freelancer'}</h3>
                                            <p className="text-xs text-brand-teal font-medium line-clamp-1 mt-0.5">
                                    ...
                                    <p className="text-xs text-gray-600 line-clamp-3 mb-3">{item.bio || 'No bio provided.'}</p>
                                    ...
                                    <div className="flex flex-wrap gap-1 mb-4">
                                        ...
                                        {item.skills?.length > 4 && (
                                            <span className="text-[11px] text-gray-400 self-center">+{item.skills.length - 4}</span>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div className="border-t border-cream-200 pt-3 flex items-center justify-between mt-1">
                                    ...
                                    <Link
                                        ...
                                        className="text-xs font-semibold bg-accent-sand text-brand-teal px-3 py-1.5 rounded hover:bg-[#B8956B] no-underline"
                                    >
                                        View Profile
                                    </Link>
                                </div>
